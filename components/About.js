			...
			<div class="general_info d-flex flex-xl-column flex-md-row flex-column">
				<div>
					<div class="general_info_image">
						<div class="background_image" style={{backgroundImage:`url(images/vipin.png)`}}></div>
					</div>
						<h1 style={{textAlign:'center',color:'white'}}>Vipin Yadav</h1>
						<h3 style={{textAlign:'center',color:'white'}}>Web Developer</h3>
						<h4 style={{textAlign:'center',color:'white'}}>1.8 year of Exp.</h4>
				</div>
						...
						<div style={{width:'30%',float:'right'}}>
							<ul class="general_info_list">
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div class="general_info_text">Name: Vipin Yadav</div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
									<div class="general_info_icon d-flex flex-column align-items-start justify-content-center"></div>
									<div class="general_info_text">Location: Ghaziabad, Uttar Pradesh, India</div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div class="general_info_text">Date of Birth: October 16, 1997</div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div class="general_info_text">vipinyadav687@gmail.com</div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div class="general_info_text">+91 8800604503</div>
								</li>
							</ul>
